...
set(FFVA_INT_CYBERON_WAKEWORD_COMPILE_DEFINITIONS
    ...
    appconfINTENT_UART_OUTPUT_ENABLED=1
    appconfAUDIO_PLAYBACK_ENABLED=0
    appconfINTENT_RESET_DELAY_MS=15000
)
...
foreach(FFVA_AP ${FFVA_PIPELINES_INT})
    ...
    # Tile Targets
    #**********************
    set(TARGET_NAME tile0_example_ffva_int_cyberon_wakeword_${FFVA_AP})
    ...
    set(TARGET_NAME tile1_example_ffva_int_cyberon_wakeword_${FFVA_AP})
    add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
    target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES} ${VNR_INTENT_ENGINE_SOURCES})
    target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES} ${VNR_INTENT_ENGINE_INCLUDES})
    target_compile_definitions(${TARGET_NAME}
    ...
    # Merge binaries
    #**********************
    merge_binaries(example_ffva_int_cyberon_wakeword_${FFVA_AP} tile0_example_ffva_int_cyberon_wakeword_${FFVA_AP} tile1_example_ffva_int_cyberon_wakeword_${FFVA_AP} 1)

    #**********************
    # Create run and debug targets
    #**********************
    create_run_target(example_ffva_int_cyberon_wakeword_${FFVA_AP})
    create_debug_target(example_ffva_int_cyberon_wakeword_${FFVA_AP})

    #**********************
    # Create data partition support targets
    #**********************
    set(TARGET_NAME example_ffva_int_cyberon_wakeword_${FFVA_AP})
